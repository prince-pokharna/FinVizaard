...
def get_vix_features(start_date: str, end_date: str) -> pd.Series:
    """
    Download ^VIX close for the date range. Returns a Series named vix_close
    indexed by calendar date (normalized). On failure, returns zeros on the
    business-day index spanning [start_date, end_date).
    """
